...
SET DEFINE OFF;
Insert into TEA10103.MANAGER (SERIAL,ACCOUNT,NAME,NICKNAME,PASSWORD,PICTURE,AUTHORITY,INTRODUCTION,MAINPULATE,DESCRIPTION,EMAIL) values (SEQ_MANAGER_ID.nextval,'Lin','林湘','湘湘','123456',null,1,'我是管理員湘湘','正常','我是一級管理員','cccc@gmail.com');
Insert into TEA10103.MANAGER (SERIAL,ACCOUNT,NAME,NICKNAME,PASSWORD,PICTURE,AUTHORITY,INTRODUCTION,MAINPULATE,DESCRIPTION,EMAIL) values (SEQ_MANAGER_ID.nextval,'shufeng','江淑芬','淑芬','123456',null,2,'我是占卜師','正常','我是占卜師兼療癒師','yyyy@gmail.com');
Insert into TEA10103.MANAGER (SERIAL,ACCOUNT,NAME,NICKNAME,PASSWORD,PICTURE,AUTHORITY,INTRODUCTION,MAINPULATE,DESCRIPTION,EMAIL) values (SEQ_MANAGER_ID.nextval,'shufeng','江淑芬','淑芬','123456',null,3,'我是療癒師','正常','我是占卜師兼療癒師','yyyy@gmail.com');
...
Insert into TEA10103.MEMBER (EMAIL,PASSWORD,NAME,PHONE,CITY,AREA,ADDRESS,BIRTHDAY,GENDER,KNOW,OCCUPATION,EPAPER,NICKNAME) values ('zzzz@gmail.com','123456','里程雲','0905148630','台北市','中正區','中山北路二段232號',TO_DATE('1984/4/6','yyyy/mm/dd'),'F','網站','工程師',1,'gas');
Insert into TEA10103.MEMBER (EMAIL,PASSWORD,NAME,PHONE,CITY,AREA,ADDRESS,BIRTHDAY,GENDER,KNOW,OCCUPATION,EPAPER,NICKNAME) values ('cccc@gmail.com','123456','林湘','0938148630','高雄市','仁愛區','忠孝路三段232號',TO_DATE('1987/12/12','yyyy/mm/dd'),'M','廣告','管理者',2,'湘湘');	  
REM INSERTING into TEA10103.MEMBERORDER
SET DEFINE OFF;
Insert into TEA10103.MEMBERORDER (ORDERNO,MACCOUNT,ORDERDATE,SNAME,PRICE,QUANTITY,TOTAL) values (1,'A@yahoo.com',to_date('20200820','yyyy/mm/dd'),'商品1',100,5,500);
Insert into TEA10103.MEMBERORDER (ORDERNO,MACCOUNT,ORDERDATE,SNAME,PRICE,QUANTITY,TOTAL) values (1,'A@yahoo.com',to_date('20200820','yyyy/mm/dd'),'商品2',50,2,100);
Insert into TEA10103.MEMBERORDER (ORDERNO,MACCOUNT,ORDERDATE,SNAME,PRICE,QUANTITY,TOTAL) values (2,'B@yahoo.com',to_date('20200820','yyyy/mm/dd'),'商品3',300,3,900);
...
SET DEFINE OFF;
Insert into TEA10103.STOREORDER (ORDERNO,ORDERDATE,MACCOUNT,TOTAL) values (1,to_date('20200820','yyyy/mm/dd'),'A@yahoo.com',2000);
Insert into TEA10103.STOREORDER (ORDERNO,ORDERDATE,MACCOUNT,TOTAL) values (2,to_date('20200820','yyyy/mm/dd'),'B@yahoo.com',200);
--------------------------------------------------------
